...
- pour les TP organisés en deux demi-groupes, les **deux TD correspondants doivent avoir eu lieu** avant toute séance de TP lorsqu'un TD de la même matière est planifié sur le même semestre ;
