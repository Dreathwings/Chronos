...
- L'algorithme de génération automatique parcourt les jours ouvrés de la plage de dates définie en alternant entre les extrémités de la plage (début/fin) et sélectionne au plus une séance par jour et par « tour » avant de revenir sur les journées déjà traitées. Les heures de début sont elles aussi pivotées entre les tours pour étaler les séances sur toute la plage possible, tout en respectant les contraintes (professeur disponible, salle adéquate, ressources requises et charge hebdomadaire maximale).
