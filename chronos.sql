...
CREATE TABLE IF NOT EXISTS `course` (
  ...
  `cm_required_hours` int(11) NOT NULL DEFAULT 0,
  ...
  CONSTRAINT `chk_course_cm_hours_non_negative` CHECK (`cm_required_hours` >= 0),
  CONSTRAINT `chk_course_type_valid` CHECK (`course_type` in ('CM','TD','TP','SAE','Eval')),
...
INSERT INTO `course` (
        ...
        `created_at`,
        `updated_at`,
        `sae_split_consecutive`,
        `sae_split_sessions`
) VALUES
        (1, 'TP - Anglais - S1', '', 2, 12, '2025-09-08', '2025-11-30', 3, 'TP', 'S1', 3, NULL, 0, 0, 0, '2025-10-15 21:10:15', '2025-10-22 12:27:06', 1, 0),
        (2, 'SAE - SAE - S1', '', 4, 14, '2025-09-08', '2025-12-06', 10, 'SAE', 'S1', 6, NULL, 0, 1, 12, '2025-10-15 22:20:41', '2025-10-23 07:26:06', 1, 1),
        (3, 'TD - Informatique - S1', '', 2, 5, NULL, NULL, 6, 'TD', 'S1', 2, NULL, 0, 1, 20, '2025-10-16 21:52:40', '2025-10-20 16:33:53', 1, 0),
        (4, 'TP - Informatique - S1', '', 2, 13, NULL, NULL, 4, 'TP', 'S1', 2, NULL, 0, 1, 12, '2025-10-16 22:05:22', '2025-10-20 16:34:03', 1, 0),
        (5, 'CM - Electronique - S1', '', 1, 8, NULL, NULL, 10, 'CM', 'S1', 1, NULL, 0, 0, 0, '2025-10-19 22:02:36', '2025-10-20 06:20:32', 1, 0),
        (6, 'TD - Electronique - S1', '', 2, 12, NULL, NULL, 6, 'TD', 'S1', 1, NULL, 0, 1, 20, '2025-10-19 22:05:09', '2025-10-20 23:41:59', 1, 0),
        (7, 'TP - Electronique - S1', '', 2, 13, NULL, NULL, 4, 'TP', 'S1', 1, NULL, 0, 1, 8, '2025-10-19 22:15:05', '2025-10-20 23:35:14', 1, 0),
        (8, 'TD - Culture Communication - S1', '', 2, 13, NULL, NULL, 4, 'TD', 'S1', 12, NULL, 0, 0, 0, '2025-10-20 13:39:39', '2025-10-20 13:39:39', 1, 0),
        (9, 'CM - Automatisme - S1', '', 1, 4, NULL, NULL, 1, 'CM', 'S1', 8, NULL, 0, 0, 0, '2025-10-21 20:59:53', '2025-10-21 21:00:39', 1, 0),
        (10, 'TD - Automatisme - S1', '', 2, 8, NULL, NULL, 1, 'TD', 'S1', 8, NULL, 0, 1, 24, '2025-10-21 21:02:25', '2025-10-21 21:03:33', 1, 0),
        (11, 'TP - Automatisme - S1', '', 2, 8, NULL, NULL, 1, 'TP', 'S1', 8, NULL, 0, 1, 12, '2025-10-21 21:05:24', '2025-10-21 21:06:04', 1, 0),
        (12, 'CM - Energie - S1', '', 2, 3, NULL, NULL, 1, 'CM', 'S1', 4, NULL, 0, 0, 0, '2025-10-21 22:46:15', '2025-10-21 22:47:08', 1, 0),
        (13, 'TD - Energie - S1', '', 2, 12, NULL, NULL, 1, 'TD', 'S1', 4, NULL, 0, 1, 24, '2025-10-21 22:54:28', '2025-10-21 22:55:43', 1, 0),
        (14, 'TP - Energie - S1', '', 2, 12, NULL, NULL, 1, 'TP', 'S1', 4, NULL, 0, 1, 6, '2025-10-21 22:58:22', '2025-10-21 23:01:29', 1, 0),
        (15, 'CM - OML - S1', '', 1, 9, NULL, NULL, 1, 'CM', 'S1', 10, NULL, 0, 0, 0, '2025-10-21 23:43:25', '2025-10-21 23:44:31', 1, 0),
        (16, 'TD - OML - S1', '', 2, 7, NULL, NULL, 1, 'TD', 'S1', 10, NULL, 0, 1, 24, '2025-10-21 23:52:32', '2025-10-22 06:57:49', 1, 0);
...
CREATE TABLE IF NOT EXISTS `course_class` (
  ...
  `teacher_a_hours` int(11) NOT NULL DEFAULT 0,
  `teacher_b_hours` int(11) NOT NULL DEFAULT 0,
  ...
  CONSTRAINT `chk_course_class_teacher_a_hours_non_negative` CHECK (`teacher_a_hours` >= 0),
  CONSTRAINT `chk_course_class_teacher_b_hours_non_negative` CHECK (`teacher_b_hours` >= 0)
...
INSERT INTO `course_class` (
        ...
        `teacher_a_id`,
        `teacher_b_id`,
        `subgroup_a_course_name_id`,
        `subgroup_b_course_name_id`,
        `teacher_a_hours`,
        `teacher_b_hours`
) VALUES
        (1, 1, 2, 48, 48, NULL, NULL, 0, 0),
        (1, 2, 2, 48, 48, NULL, NULL, 0, 0),
        (1, 3, 2, 59, 59, NULL, NULL, 0, 0),
        (1, 4, 2, 48, 48, NULL, NULL, 0, 0),
        (2, 1, 1, 4, 2, NULL, NULL, 0, 0),
        (2, 2, 1, 15, 46, NULL, NULL, 0, 0),
        (2, 3, 1, 11, 4, NULL, NULL, 0, 0),
        (2, 4, 1, 4, 56, NULL, NULL, 0, 0),
        (3, 1, 1, 51, NULL, NULL, NULL, 0, 0),
        (3, 2, 1, 30, NULL, NULL, NULL, 0, 0),
        (3, 3, 1, 57, NULL, NULL, NULL, 0, 0),
        (3, 4, 1, 56, NULL, NULL, NULL, 0, 0),
        (4, 1, 2, 51, 51, NULL, NULL, 0, 0),
        (4, 2, 2, 30, 30, NULL, NULL, 0, 0),
        (4, 3, 2, 30, 57, NULL, NULL, 0, 0),
        (4, 4, 2, 56, 56, NULL, NULL, 0, 0),
        (5, 1, 1, 15, NULL, NULL, NULL, 0, 0),
        (5, 2, 1, 15, NULL, NULL, NULL, 0, 0),
        (5, 3, 1, 15, NULL, NULL, NULL, 0, 0),
        (5, 4, 1, 15, NULL, NULL, NULL, 0, 0),
        (6, 1, 1, 26, NULL, NULL, NULL, 0, 0),
        (6, 2, 1, 15, NULL, NULL, NULL, 0, 0),
        (6, 3, 1, 17, NULL, NULL, NULL, 0, 0),
        (6, 4, 1, 31, NULL, NULL, NULL, 0, 0),
        (7, 1, 2, 8, 31, NULL, NULL, 0, 0),
        (7, 2, 2, 17, 15, NULL, NULL, 0, 0),
        (7, 3, 2, 29, 35, NULL, NULL, 0, 0),
        (7, 4, 2, 26, 58, NULL, NULL, 0, 0),
        (8, 1, 1, 34, NULL, NULL, NULL, 0, 0),
        (8, 2, 1, 34, NULL, NULL, NULL, 0, 0),
        (8, 3, 1, 53, NULL, NULL, NULL, 0, 0),
        (8, 4, 1, 53, NULL, NULL, NULL, 0, 0),
        (9, 1, 1, 28, NULL, NULL, NULL, 0, 0),
        (9, 2, 1, 28, NULL, NULL, NULL, 0, 0),
        (9, 3, 1, 28, NULL, NULL, NULL, 0, 0),
        (9, 4, 1, 28, NULL, NULL, NULL, 0, 0),
        (10, 1, 1, 16, NULL, NULL, NULL, 0, 0),
        (10, 2, 1, 28, NULL, NULL, NULL, 0, 0),
        (10, 3, 1, 1, NULL, NULL, NULL, 0, 0),
        (10, 4, 1, 41, NULL, NULL, NULL, 0, 0),
        (11, 1, 2, 31, 41, NULL, NULL, 0, 0),
        (11, 2, 2, 2, 28, NULL, NULL, 0, 0),
        (11, 3, 2, 16, 47, NULL, NULL, 0, 0),
        (11, 4, 2, 15, 1, NULL, NULL, 0, 0),
        (12, 1, 1, 25, NULL, NULL, NULL, 0, 0),
        (12, 2, 1, 25, NULL, NULL, NULL, 0, 0),
        (12, 3, 1, 25, NULL, NULL, NULL, 0, 0),
        (12, 4, 1, 25, NULL, NULL, NULL, 0, 0),
        (13, 1, 1, 13, NULL, NULL, NULL, 0, 0),
        (13, 2, 1, 46, NULL, NULL, NULL, 0, 0),
        (13, 3, 1, 46, NULL, NULL, NULL, 0, 0),
        (13, 4, 1, 29, NULL, NULL, NULL, 0, 0),
        (14, 1, 2, 46, 46, NULL, NULL, 0, 0),
        (14, 2, 2, 29, 23, NULL, NULL, 0, 0),
        (14, 3, 2, 13, 25, NULL, NULL, 0, 0),
        (14, 4, 2, 2, 2, NULL, NULL, 0, 0),
        (15, 1, 1, 3, NULL, NULL, NULL, 0, 0),
        (15, 2, 1, 3, NULL, NULL, NULL, 0, 0),
        (15, 3, 1, 3, NULL, NULL, NULL, 0, 0),
        (15, 4, 1, 3, NULL, NULL, NULL, 0, 0),
        (16, 1, 1, 3, NULL, NULL, NULL, 0, 0),
        (16, 2, 1, 3, NULL, NULL, NULL, 0, 0),
        (16, 3, 1, 3, NULL, NULL, NULL, 0, 0),
        (16, 4, 1, 27, NULL, NULL, NULL, 0, 0);
